package com.iso.player.settings.groups
...
abstract class Group(val headerText: TextView, var items: List<MaterialCardView>? = null) {
    ...
    abstract class Builder<out K, out T : Group>(val context: Context) {
        ...
        fun build(): T {
            ...
            return customBuild(headerTextView, items, groupItems).apply {
        ...
        abstract fun customBuild(headerText: MaterialTextView, items: List<MaterialCardView>?, groupItems: Array<out GroupItem?>?) : T
