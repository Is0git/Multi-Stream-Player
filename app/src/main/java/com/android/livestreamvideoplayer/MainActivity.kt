...
import com.android.multistreamplayer.api.twitch.Retrofit
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        (binding.root as MultiStreamPlayerLayout).apply {
            ...
            val chatType = ChatType.TwitchChatType("is0xxx", "7uyg0kooxcagt096sig5f2i023mrdk", channelName, object : DataListener {
